...
const TitleBox = styled.divpadding: 0 5%; z-index: 10; position: relative; width: fit-content;
    ${mediaTablet} { padding: 0 5vw; }
;
const Sub = styled.divfont-size: 23px; font-weight: 500; padding-bottom: 10px;
...
const Coffee = styled.divcolor: ${(props)=>props.theme.gray4}; line-height: 1.5; margin: 30px 0 25px;
const Mode = styled.divcursor:pointer; display:inline-block; width: fit-content;
